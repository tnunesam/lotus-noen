...
public class Generics {
	...
	public List<WebElement> mapeiaTela(){
		List<WebElement> objetos = driver.findElements(MobileBy.xpath("//*"));
		return objetos;
	}
...
//			
//			String context = ((IOSDriver) driver).getContext();
	...
	public void scrollUp(){
        ...
        ((IOSDriver) driver).swipe(screenWidth-1, screenHeight-1, screenWidth-5, 0  , 500);
	}
	...
	public void scrollDown(){
        ...
        ((IOSDriver) driver).swipe(screenWidth-1, 0, screenWidth-1, screenHeight-5  , 500);
	}
	...
	public void scrollLeft(){
        ...
        ((IOSDriver) driver).swipe(screenWidth-1, screenHeight-5, 0, screenHeight-5  , 500);
	}
	...
	public void scrollRight(){
        ...
        ((IOSDriver) driver).swipe(0, screenHeight-5, screenWidth-1, screenHeight-5  , 500);
	}
	...
	public void pressKeyCode(int tecla){
		...
		((IOSDriver) driver).sendKeyEvent(tecla);
...
//		System.out.println("Verificando existencia " + name);
		...
		List<WebElement> elementos = driver.findElements(MobileBy.className(classe));
		if (elementos.size()>0){
			if (tipo.toLowerCase()=="name"){
